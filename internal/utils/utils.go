...
func FindCyberTrucks() (models.CyberTruckInventoryResponse, error) {
	...
	client := &http.Client{
		Transport: tr,
		Timeout:   30 * time.Second, // Set a reasonable timeout for the request.
	}
